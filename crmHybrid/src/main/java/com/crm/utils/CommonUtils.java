...
return list;
	...
	public static void selectDropDownItem(String identifiedBy, String locator,
			String itemType, String value, WebDriver wd) {
	...
	public static boolean isElementPresent(String identifiedBy, String locator,
			WebDriver wd) {
		WebElement element = null;
